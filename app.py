# =====================================================================================
# == FINAL STABLE PRODUCTION VERSION V27.0 - Simplified & Corrected for Stability ==
# =====================================================================================
...
# --- PDF to Word (Using the CORRECT LibreOffice syntax) ---
...
def pdf_to_word():
    ...
    # Use the syntax that LibreOffice version 7.0 requires
    return convert_with_libreoffice(file, "docx:writer_pdf_import")

# --- PDF to Excel (Uses its own logic, no changes needed) ---
...
# --- Universal Converter Function (Simple, Stable & Final) ---
def convert_with_libreoffice(file, output_filter):
    ...
    try:
        ...
        # Run command with full output capture for debugging
        ...
        # This 'finally' block ensures files are ALWAYS cleaned up, preventing server issues.
        try:
